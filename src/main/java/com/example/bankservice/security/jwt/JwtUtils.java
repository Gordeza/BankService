...
public class JwtUtils {
  ...
  private final String jwtSecret = "EGS_Bank_Service";

  private final int jwtExpirationMs = 70000000;

  public String generateJwtToken(Authentication authentication) {

    CardDetailsImpl userPrincipal = (CardDetailsImpl) authentication.getPrincipal();
